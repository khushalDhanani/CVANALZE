...
class ExtractionPolicy(BaseModel):
    ...
    skill_max_lines: int = Field(default=512, ge=1, le=10_000)
    skill_max_items: int = Field(default=256, ge=1, le=2_000)
    skill_max_items_per_category: int = Field(default=128, ge=1, le=1_000)
